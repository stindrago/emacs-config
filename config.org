...
#+html: <a href="https://www.gnu.org/software/emacs/emacs.html#Releases"><img 
src="https://img.shields.io/badge/Emacs-27.1%20%E2%80%93%2028.0.50-blueviolet.svg?style=flat-square&logo=GNU%20Emacs&logoColor=white"></a>
#+html: <a href="https://orgmode.org"><img 
src="https://img.shields.io/badge/Org-literate%20config-%2377aa99?style=flat-square&logo=org&logoColor=white"></a>
#+html: <a href="https://www.buymeacoffee.com/stindrago"><img 
src="https://img.shields.io/badge/Buy_me_a%C2%A0coffee-FFDD00?style=flat-square&logo=buy-me-a-coffee&logoColor=black"></a>
...
#+begin_src emacs-lisp
(setq main-directory "~/resources/"
      org-directory (concat main-directory "org/")
      org-agenda-files '(org-directory)
      org-roam-db-location (concat org-directory ".org-roam.db")
      org-roam-directory (file-truename (concat org-directory "org/roam/"))
...
(setq org-roam-capture-templates
        `(("c" "📞 New Contact" plain (file ".new-contact.txt")
...
(after! org-agenda
  (setq org-agenda-include-diary nil
          ...
          org-super-agenda-header-prefix nil ;; "    ｟ "
          ...
          org-agenda-timerange-leaders '("🕣" "🕣%2d")
  ...
  (setq org-agenda-custom-commands
        '(("o" "🔎 Overview"
           ((alltodo "" ((org-agenda-overriding-header "")
            ...
            (tags "combo" ((org-agenda-overriding-header "🥋 Today Combos")
                           (org-agenda-block-separator "\n----")
                           (org-super-agenda-groups
                            '((:discard (:not (:deadline today :scheduled today)))
                              (:auto-parent t)
                              (:discard (:anything t))))))
            (tags "combo" ((org-agenda-overriding-header "🥋 Due Combos")
                           (org-agenda-block-separator "\n----")
                           (org-super-agenda-groups
           ...
           ((alltodo "" ((org-agenda-overriding-header "")
                         (org-super-agenda-groups
                          '((:name "\n   📥 Inbox\n   —————————\n" :category "inbox" :order 1)
                            ...
                            (:discard (:anything t))))))
            (tags "combo" ((org-agenda-overriding-header "🥋 Combos Not Updated")
                           (org-agenda-block-separator "\n----")
                           (org-super-agenda-groups
                            '((:discard (:not (:deadline past :scheduled past)))
                              (:auto-parent t)
                              (:discard (:anything t))))))))
          ("c" "🥋 All Combos"
           ((tags "combo" ((org-agenda-overriding-header "🥋 All Combos")
                           (org-super-agenda-groups
          ...
          ("l" "📜 List"
           ((agenda "" ((org-agenda-start-day "+0d")
            ...
            (alltodo "" ((org-agenda-overriding-header "📜 List All Todo")
...
(use-package! doct
  ...
  (setq org-capture-templates
        (doct '(("📂 Project" :keys "p"
                 ...
                 :children (("Standard"  :keys "1"
                             :title "%^{title}"
                             :author "%(print custom/nickname)"
                             :date  "%<%Y-%m-%dT%H:%M:%S>"
                             :filetags "inbox"
                             :category "private"
                             :hook (lambda () (message "Standard child selected.")
                                     (org-id-get-create)))))))))
#+end_src
